        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="py-3 bg-background border border-border rounded-xl flex items-center justify-center gap-3 hover:bg-muted/50 transition-all disabled:opacity-70"
            >
              <GoogleIcon />
